...
let monsterModifers : string[] = ["Ist nervig", "Linkshänder", "Bier-Connoisseur", "Verfehlt häufig", "Prokrastiniert", "Müde", "Verwirrt", "Wasserscheu", "Bipolar", "Hat Schnupfen", "Verläuft sich oft"]; // Eine Reihe von zufälligen "Verstärkern" für das Monster. lenghth = 11 VOn 0-10
let items : string[] = ["Flammenwerfer", "Handtuch", "IPhone", "Magnet", "Wasserpistole", "Große Schuhe", "Buch", "Holzpfahl", "Schnuller", "Alkoholfreies-Bier", "Allmächtiges Schwert"]; //Eine Reihe von zufälligen "Verstärkern" für das Monster. leghth = 11 Von 0-10.
...
"imgs/MonsterIcon11.png", "imgs/MonsterIcon12.png", "imgs/MonsterIcon13.png", "imgs/MonsterIcon14.png", "imgs/MonsterIcon15.png", "imgs/MonsterIcon16.png", "imgs/MonsterIcon17.png", "imgs/MonsterIcon18.png", "imgs/MonsterIcon19.png", "imgs/MonsterIcon20.png"]; // Eine Reihe von zufälligen Bildern für das Monster. lenghth = 20 VOn 0-19
...
function generateMonsterName(typeAsPrefix : string) : string                    //Der Funktion wird der Monster-Typ mitgegeben , um diesen als Prefix zu benutzen>
{
    let generatedMonsterName : string = typeAsPrefix + "-";                     //Der Name wird deklariert. Er beginnt mit dem Typ und einem Bindestrich
...
function generateMonsterHitPoints() : number
{
    ...
    let tempMonsterHP : number = 5 + getRNGNumber(10);                          // Da HP jetzt als Hit-Points genutzt werden, wurde der Wert ein wenig angepasst
...
function generateMonsterXP() : number
{
    ...
    let tempMonsterXP : number = 100 + getRNGNumber(900);                       // Wert wurde angepasst     // 🗹 Mindestanforderung Nr. 7
...
{
    let tempMonsterMoney : number = 100 + getRNGNumber(400);                    // Diese Funktion gibt eine zufällige ganze Zahl (zwischen 0 und 400) + 100 zurück.
...
{
    let rngNumber : number = getRNGNumber(items.length-1);                      // Diese Funktion gibt einen zufälligen String aus dem Items-Array zurück.
    return items[rngNumber];             
}

function generateMonsterIcon() : string
{
    let rngNumber : number = getRNGNumber(monsterIcons.length-1);               // Diese Funktion gibt einen zufälligen Bild-Pfad zurück.
